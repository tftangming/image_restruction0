 ...
 *
 * conf: scene_path=argv[1] ;ply_dest =recon ; master_id = argv[3] ; view_ids ; max_pixels = 1500000 ; force_recon = false ; write_ply = true
 **/
...
main (int argc, char** argv)
{
    ...
    conf.mvs.plyPath = util::fs::join_path(conf.scene_path, conf.ply_dest);//设置多视图立体的点云输出文件路径
